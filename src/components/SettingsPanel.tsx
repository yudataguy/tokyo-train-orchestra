  ...
  return (
    <div className="absolute top-0 right-0 bottom-0 z-[1100] w-72 bg-slate-900/95 backdrop-blur-lg border-l border-slate-700 p-5 overflow-y-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={onClose} className="text-gray-400 hover:text-white text-xl" aria-label="Close settings">&times;</button>
      </div>

      <div className="mb-6">
        <label className="text-xs uppercase tracking-wider text-gray-500 block mb-2">Master Volume</label>
      ...
      <div>
        <label className="text-xs uppercase tracking-wider text-gray-500 block mb-3">Lines</label>
